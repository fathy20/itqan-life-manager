            ...
            {tab === "today" && (
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                {[
                  ...
                  <div key={item.key} style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 20, animation: "fadeIn 0.3s" }}>
                ...
                {habits.length === 0 ? (
                  ...
                  return (
                    <div key={h.id} onClick={() => toggleHabit(h)} style={{
                      ...
                      background: CARD, border: `1px solid ${isDone ? "#10B98140" : BORDER}`,
