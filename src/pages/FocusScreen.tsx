    ...
    <div style={{ minHeight: "100vh", background: BG, color: TEXT }}>
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "40px 20px", textAlign: "center" }}>
        ...
        <input value={label} onChange={e => setLabel(e.target.value)} placeholder="وصف اختياري..."
          style={{ width: 280, background: CARD, border: `1px solid ${BORDER}`, borderRadius: 10, padding: "10px 16px", color: TEXT, fontSize: 13, fontFamily: "'Noto Kufi Arabic', sans-serif", textAlign: "center", marginBottom: 24 }} />

        {/* Controls */}
        <div style={{ display: "flex", gap: 12, justifyContent: "center", marginBottom: 40 }}>
          <button onClick={resetTimer} style={{ width: 48, height: 48, borderRadius: "50%", background: CARD, border: `1px solid ${BORDER}`, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <button onClick={() => { if (!running && timeLeft < duration * 60) completeSession(); }} style={{ width: 48, height: 48, borderRadius: "50%", background: CARD, border: `1px solid ${BORDER}`, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{ display: "flex", gap: 16, justifyContent: "center", marginBottom: 32 }}>
          <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 12, padding: "12px 24px", textAlign: "center" }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            {todaySessions.slice(0, 5).map(s => (
              <div key={s.id} style={{
                ...
                background: CARD, border: `1px solid ${BORDER}`, borderRadius: 10, marginBottom: 6,
              }}>
