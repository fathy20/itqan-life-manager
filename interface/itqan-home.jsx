...
import {
  ...
  Utensils, Dumbbell, Clock, Zap, LogOut, User
} from "lucide-react";

const MODULES = [
  {
    id: "dashboard", nameAr: "الرئيسية", nameEn: "Dashboard",
    icon: LayoutDashboard, color: "#08A7E7", desc: "نظرة شاملة على يومك",
    size: "large",
  },
  {
    id: "salah", nameAr: "الصلاة", nameEn: "Salah",
    icon: Moon, color: "#A78BFA", desc: "مواقيت وتتبع الصلوات",
    badge: "العصر 3:45",
    size: "normal",
  },
  {
    id: "quran", nameAr: "القرآن", nameEn: "Quran",
    icon: BookOpen, color: "#34D399", desc: "ختمة · حفظ · مراجعة",
    badge: "4 صفحات اليوم",
    size: "normal",
  },
  {
    id: "adhkar", nameAr: "الأذكار", nameEn: "Adhkar",
    icon: Star, color: "#FBBF24", desc: "أذكار الصباح والمساء",
    badge: "الصباح ✓",
    size: "normal",
  },
  {
    id: "sibaq", nameAr: "السباق", nameEn: "Sibaq",
    icon: Users, color: "#F472B6", desc: "تنافس مع أصحابك",
    badge: "Rank: متقن",
    size: "normal",
  },
  {
    id: "study", nameAr: "الدراسة", nameEn: "Study",
    icon: GraduationCap, color: "#60A5FA", desc: "المواد والامتحانات",
    badge: "امتحان بعد 5 أيام",
    size: "normal",
  },
  {
    id: "work", nameAr: "العمل", nameEn: "Work",
    icon: Briefcase, color: "#FB923C", desc: "مهام · مشاريع · كورسات",
    size: "normal",
  },
  {
    id: "finance", nameAr: "الماليات", nameEn: "Finance",
    icon: Wallet, color: "#4ADE80", desc: "ميزانية · زكاة · صدقات",
    locked: true,
    size: "normal",
  },
  {
    id: "lifestyle", nameAr: "الصحة", nameEn: "Health",
    icon: Heart, color: "#F87171", desc: "عادات · نوم · تمارين · أكل",
    size: "normal",
  },
  {
    id: "calendar", nameAr: "التقويم", nameEn: "Calendar",
    icon: Calendar, color: "#818CF8", desc: "هجري + ميلادي",
    size: "normal",
  },
  {
    id: "focus", nameAr: "التركيز", nameEn: "Focus",
    icon: Timer, color: "#FB923C", desc: "مؤقت البومودورو",
    size: "normal",
  },
  {
    id: "coach", nameAr: "المدرب", nameEn: "AI Coach",
    icon: Sparkles, color: "#08A7E7", desc: "مدربك الذكي بالـ AI",
    size: "normal",
  },
];

function ItqanLogo({ size = 40 }) {
  const r = size / 2;
  const petals = 12;
  return (
    <svg width={size} height={size} viewBox="0 0 80 80">
      ...
      {Array.from({ length: 8 }).map((_, i) => {
        ...
        return <circle key={`d-${i}`} cx={x} cy={y} r="2.5" fill="#08A7E7" opacity="0.5" />;
      })}
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: isLarge ? 16 : 12 }}>
          <div style={{
            ...
            transition: "all 0.3s",
            boxShadow: hovered ? `0 0 20px ${mod.color}20` : "none",
          }}>
...
export default function ItqanHome() {
  ...
  const handleModuleClick = (id) => {
    setActiveModule(id);
    setTimeout(() => setActiveModule(null), 600);
  };

  return (
    <div style={{
      minHeight: "100vh", background: "#000E30",
      fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif",
      color: "#C0C8D8", position: "relative", overflow: "hidden",
    }}>
      ...
      <div style={{ position: "fixed", inset: 0, pointerEvents: "none", overflow: "hidden" }}>
        {/* Geometric mandala - very subtle */}
        <svg style={{
          position: "absolute", top: "50%", left: "50%", width: 900, height: 900,
          transform: "translate(-50%, -50%)", opacity: 0.02,
        ...
        <div style={{
          ...
          borderRadius: "50%", background: "#08A7E7",
          animation: "pulseGlow 6s ease infinite", filter: "blur(120px)",
        }} />
        <div style={{
          position: "absolute", bottom: -200, left: -200, width: 400, height: 400,
          borderRadius: "50%", background: "#A78BFA",
          opacity: 0.03, filter: "blur(120px)",
        }} />
      </div>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1100, margin: "0 auto", padding: "0 40px" }}>
        ...
        <div style={{
          ...
          padding: "20px 0", animation: "slideDown 0.6s ease",
        }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  color: "#C0C8D8", width: "100%", fontFamily: "inherit",
                }}
              />
              <div style={{
                padding: "2px 6px", borderRadius: 4, background: "#0F2847",
                fontSize: 10, color: "#3D5A80", fontFamily: "'JetBrains Mono', monospace",
              }}>
            ...
            <button style={{
              width: 36, height: 36, borderRadius: 10, border: "1px solid #0F2847",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ textAlign: "right" }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: "#C0C8D8" }}>Fathy</div>
                <div style={{ fontSize: 10, color: "#08A7E7", fontFamily: "'Noto Kufi Arabic', sans-serif" }}>متقن</div>
              </div>
              <div style={{
                width: 38, height: 38, borderRadius: "50%",
                background: "linear-gradient(135deg, #08A7E720, #08A7E708)",
                border: "2px solid #08A7E730",
                display: "flex", alignItems: "center", justifyContent: "center",
              }}>
                <span style={{ fontSize: 15, fontWeight: 600, color: "#08A7E7" }}>F</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{
              fontSize: 14, color: "#3D5A80", marginBottom: 4,
              fontFamily: "'Noto Kufi Arabic', sans-serif",
            }}>
              {greeting()} يا فتحي
            </div>
            <div style={{
              fontSize: 28, fontWeight: 700, color: "#E8EBF0",
              fontFamily: "'Noto Kufi Arabic', sans-serif",
              letterSpacing: "-0.5px",
            }}>
              اختر وِجهتك اليوم
            ...
            <div style={{
              fontSize: 12, color: "#2A4A6A", marginTop: 4,
              fontFamily: "'JetBrains Mono', monospace",
            }}>
              {time.toLocaleDateString("en-US", { weekday: "long", month: "short", day: "numeric", year: "numeric" })}
              {" · "}
              <span style={{ fontFamily: "'Noto Kufi Arabic', sans-serif" }}>٥ شوال ١٤٤٧</span>
            </div>
          </div>

          <div style={{ display: "flex", gap: 10 }}>
            <QuickStat icon={Flame} label="Streak" value="18 days" color="#FB923C" />
            <QuickStat icon={TrendingUp} label="Score" value="83/100" color="#08A7E7" />
            <QuickStat icon={Clock} label="Next prayer" value="Asr 3:45" color="#A78BFA" />
          </div>
        </div>
        ...
        <div style={{
          ...
          {MODULES.map((mod, i) => (
            <ModuleCard key={mod.id} mod={mod} index={i} onClick={handleModuleClick} />
          ))}
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 11, color: "#2A4A6A", fontFamily: "'JetBrains Mono', monospace" }}>
            v2.0 — Itqan Life OS
          </div>
          <div style={{ width: 1, height: 12, background: "#0F2847" }} />
          <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 11, color: "#2A4A6A" }}>
      ...
      {activeModule && (
        <div style={{
          ...
          background: "#000E30", display: "flex", alignItems: "center", justifyContent: "center",
            ...
            {(() => {
              ...
              return (
                <>
                  ...
                  <div style={{
                    fontSize: 24, fontWeight: 700, color: mod.color,
                    fontFamily: "'Noto Kufi Arabic', sans-serif",
                  }}>{mod.nameAr}</div>
                  <div style={{
                    fontSize: 12, color: "#3D5A80", marginTop: 4,
                    fontFamily: "'JetBrains Mono', monospace",
                  }}>Loading...</div>
                </>
              );
